...
const u16 gMetatiles_Farm_Start[] = INCBIN_U16("data/tilesets/primary/farm_start/metatiles.bin");
const u16 gMetatileAttributes_Farm_Start[] = INCBIN_U16("data/tilesets/primary/farm_start/metatile_attributes.bin");
